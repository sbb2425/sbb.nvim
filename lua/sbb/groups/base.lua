...
function M.get(opts, c)
  return {
    ...
    BufferCurrentIndex = { fg = c.ui.fg.inverse, bg = c.accent.cyan.default },
    BufferInactiveIndex = { fg = c.accent.gray.default, bg = c.accent.gray.dark },
    BufferVisibleIndex = { fg = c.accent.gray.default, bg = c.accent.gray.dark },
    BufferAlternateIndex = { fg = c.accent.gray.default, bg = c.accent.gray.dark },
    BufferCurrentBtn = { fg = c.accent.gray.default, bg = "NONE" },
    BufferInactiveBtn  = { fg = c.accent.gray.default, bg = "NONE" },
    BufferVisibleBtn  = { fg = c.accent.gray.default, bg = "NONE" },
    BufferAlternateBtn  = { fg = c.accent.gray.default, bg = "NONE" },
    BufferCurrentModBtn  = { fg = c.accent.purple.default, bg = "NONE" },
    BufferInactiveModBtn  = { fg = c.accent.purple.dark, bg = "NONE" },
    BufferCurrentMod = { fg = c.accent.purple.default, bg = "NONE" },
    BufferInactiveMod = { fg = c.accent.purple.dark, bg = "NONE" },
    BufferVisibleMod = { fg = c.accent.purple.dark, bg = "NONE" },
    BufferAlternateMod = { fg = c.accent.purple.dark, bg = "NONE" },
