...
function M.get(opts, c)
  return {
    ...
    --MarkdownRender
    RenderMarkdownH1 = { fg = c.accent.green.bright },
    RenderMarkdownH2 = { fg = c.accent.cyan.bright },
    ...
    RenderMarkdownH1Bg = { fg = c.accent.green.bright, bg = c.accent.green.dim },
    RenderMarkdownH2Bg = { fg = c.accent.cyan.bright, bg = c.accent.cyan.dim },
    ...
    RenderMarkdownTableHead = { fg = c.accent.blue.default, bg = c.accent.gray.dark },
    RenderMarkdownTableRow = { fg = c.ui.fg.muted, bg = c.accent.gray.dark },
    RenderMarkdownSuccess = { fg = c.accent.cyan.bright, bg = c.accent.cyan.dark },
    RenderMarkdownHint = { fg = c.accent.green.bright, bg = c.accent.green.dark },
    RenderMarkdownWarn = { fg = c.accent.orange.bright, bg = c.accent.orange.dark },
    RenderMarkdownInfo = { fg = c.accent.purple.bright, bg = c.accent.purple.dark },
    RenderMarkdownError = { fg = c.accent.red.bright, bg = c.accent.red.dark },
    RenderMarkdownQuote = { fg = c.accent.purple.bright, bg = c.accent.purple.dark },
