...
function M.get(opts, c)
  return {
    --MarkdownRender
    RenderMarkdownH1 = { fg = c.accent.cyan.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH2 = { fg = c.accent.green.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH3 = { fg = c.accent.blue.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH4 = { fg = c.accent.purple.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH5 = { fg = c.accent.orange.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH6 = { fg = c.accent.yellow.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH1Bg = { fg = c.accent.cyan.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH2Bg = { fg = c.accent.green.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH3Bg = { fg = c.accent.blue.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH4Bg = { fg = c.accent.purple.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH5Bg = { fg = c.accent.orange.deafult, bg = c.ui.bg.soft },
    RenderMarkdownH6Bg = { fg = c.accent.yellow.deafult, bg = c.ui.bg.soft },
